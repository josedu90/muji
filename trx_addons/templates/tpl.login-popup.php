		...
		<div id="trx_addons_login_content" class="trx_addons_tabs_content trx_addons_login_content">
						...
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_login">
							...
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															...
															array(
																...
																'field_title' => esc_attr__('Login', 'muji'),
																'field_placeholder' => esc_attr__('Login', 'muji')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
							...
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															...
															array(
																...
																'field_title' => esc_attr__('Password', 'muji'),
																'field_placeholder' => esc_attr__('Password', 'muji')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_remember">
							<a href="<?php echo esc_url(wp_lostpassword_url(get_permalink())); ?>" class="trx_addons_popup_form_field_forgot_password"><?php esc_html_e('Forgot password?', 'muji'); ?></a>
							<input type="checkbox" value="forever" id="rememberme" name="rememberme"><label for="rememberme"> <?php esc_html_e('Remember me', 'muji'); ?></label>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
							<input type="submit" class="submit_button" value="<?php esc_attr_e('Login', 'muji'); ?>">
						</div>
			...
			<?php if (!empty($trx_addons_login_via_socials)) { ?>
				<div class="trx_addons_right_side">
					<div class="trx_addons_login_socials_title"><?php esc_html_e('or you can login using your favorite social profile!', 'muji'); ?></div>
			...
			<div id="trx_addons_register_content" class="trx_addons_tabs_content">
				<div class="trx_addons_popup_form_wrap trx_addons_popup_form_wrap_register">
					<form class="trx_addons_popup_form trx_addons_popup_form_register <?php if ($trx_addons_form_style != 'default') echo 'sc_input_hover_'.esc_attr($trx_addons_form_style); ?>" action="<?php echo wp_login_url(); ?>" method="post" name="trx_addons_login_form">
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_email">
								...
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																...
																array(
																	...
																	'field_placeholder' => esc_attr__('E-mail', 'muji')
																	)
															);
								?>
							</div>
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
								...
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																...
																array(
																	...
																	'field_req'   => true,
																	'field_icon'  => 'trx_addons_icon-lock',
																	'field_title' => esc_attr__('Confirm Password', 'muji'),
																	'field_placeholder' => esc_attr__('Confirm Password', 'muji')
																	)
															);
								?>
							</div>
						...
						?>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
							<input type="submit" class="submit_button" value="<?php esc_attr_e('Sign Up', 'muji'); ?>">
						</div>
						<div class="trx_addons_message_box sc_form_result"></div>
					</form>
				</div>
