...
if (!function_exists('muji_trx_addons_get_css')) {
	add_filter('muji_filter_get_css', 'muji_trx_addons_get_css', 10, 4);
	function muji_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.with-mask .slider_container .slider_pagination_wrap .swiper-pagination-bullet,
.with-mask .slider_outer .slider_pagination_wrap .swiper-pagination-bullet,
.with-mask .swiper-pagination-custom .swiper-pagination-button {
	border-color: {$colors['inverse_link']};
	background-color: {$colors['inverse_link']};
}
.with-mask .swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active,
.with-mask .slider_container .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.with-mask .slider_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.with-mask .slider_container .slider_pagination_wrap .swiper-pagination-bullet:hover,
.with-mask .slider_outer .slider_pagination_wrap .swiper-pagination-bullet:hover {
	border-color: {$colors['inverse_link']};
	background-color: {$colors['inverse_link']};
}
...
.sc_price_item .sc_price_item_description li span,
.sc_price_item .sc_price_item_details li span {
	color: {$colors['alter_link']};
}
