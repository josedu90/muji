...
if (!function_exists('muji_customizer_get_css')) {

	function muji_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = muji_customizer_add_theme_fonts($fonts);
			...
			$fonts['h6_font-weight!'] = str_replace(';', ' !important;', $fonts['h6_font-weight']);
			$fonts['button_font-weight!'] = str_replace(';', ' !important;', $fonts['button_font-weight']);
			$fonts['info_font-weight!'] = str_replace(';', ' !important;', $fonts['info_font-weight']);
			$fonts['decor_font-family!'] = str_replace(';', ' !important;', $fonts['decor_font-family']);
...
.muji_tabs .muji_tabs_titles li a {
...
.nav-links .page-numbers, .comments_list_wrap .comment_reply,
...
.post-footer>.post_meta .post_meta_item.post_counters_views {
	{$fonts['h6_font-family!']}
	{$fonts['h6_font-weight']} !important;
}
...
.mejs-container *, .post_meta_item.post_author, 
...
CSS;
			$rez = apply_filters('muji_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(muji_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = muji_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = muji_customizer_add_theme_colors($colors);
...
/* not i, because it used as icons container */
	color: {$colors['text_dark']};
}
s, strike, del {	
	color: {$colors['text']};
...
.wp-block-table.is-style-stripes table tr:nth-child(2n) th,
...
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['input_dark']}; }
input[placeholder]::-moz-placeholder,
textarea[placeholder]::-moz-placeholder				{ color: {$colors['input_dark']}; }
input[placeholder]:-ms-input-placeholder,
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['input_dark']}; }
input[placeholder]::placeholder,
textarea[placeholder]::placeholder					{ color: {$colors['input_dark']}; }
...
.wpcf7-form-control-wrap.wpgdprc a {
    color: {$colors['text_link']} !important;
}
.wpcf7-form-control-wrap.wpgdprc a:hover,
 .footer_wrap .scheme_self.vc_row .wpcf7-form-control-wrap.wpgdprc a:hover {
...
.sc_price_item.sc_price_item_alter:hover .sc_price_item_title {
    color: {$colors['text_link']};
}
...
/*Unit Test*/
.header_style_header-default .sc_layouts_menu_nav > a:hover,
.header_style_header-default .sc_layouts_menu_nav > li > a:hover,
.header_style_header-default .sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['text_dark']};
	background-color: {$colors['text_link2']};
}
...
.muji_tabs .muji_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.muji_tabs .muji_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .muji_tabs .muji_tabs_titles li.ui-state-active a {
...
.scheme_self.sidebar .widget_rss .widget_title a:first-child,
 .scheme_self.sidebar .widget_rss .widget_title a {
	color: {$colors['inverse_link']};
}
...
.scheme_self.sidebar .widget_rss .widget_title a:first-child:hover,
 .scheme_self.sidebar .widget_rss .widget_title a:hover {
	color: {$colors['inverse_dark']};
}
.widget_rss .rss-date {
	color: {$colors['text_dark']};
...
/*Header*/
header .sc_layouts_item_link .sc_layouts_item_details_line2,
header .sc_layouts_iconed_text .sc_layouts_item_details_line2 {
     color: {$colors['alter_link']} !important;
}
header .sc_layouts_item_link:hover  .sc_layouts_item_details_line2  {
     color: {$colors['text_dark']} !important;
}
header .sc_layouts_iconed_text  .sc_layouts_iconed_text_icon {
     color: {$colors['text_hover']} !important;
}
header .sc_layouts_row_type_compact .sc_layouts_iconed_text .sc_layouts_iconed_text_icon {
     color: {$colors['text_dark']} !important;
     background-color: {$colors['text_link2']};
}
header .sc_layouts_iconed_text .sc_layouts_iconed_text_icon:hover {
     color: {$colors['text_hover']} !important;
     background-color: transparent;
}
header .sc_layouts_title_meta .post_meta_item a:hover,
header .sc_layouts_title_meta a.post_meta_item:hover {
    color: {$colors['text_hover2']} !important;
}
...
CSS;
					...
					$rez = apply_filters('muji_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'muji_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>