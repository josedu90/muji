...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (MUJI_STORAGE['button_hover'] && MUJI_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]):not([class*="xdsoft_"]):not([class*="datepicker-button"]),\
				...
				.muji_tabs .muji_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				.mc-btn\
				').addClass('sc_button_hover_just_init sc_button_hover_'+MUJI_STORAGE['button_hover']);
		if (MUJI_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.muji_tabs .muji_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+MUJI_STORAGE['button_hover']);
